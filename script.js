...
const products = [
  ...
  },
  {
    ...
    reviews: 430,
    image:
      "https://m.media-amazon.com/images/I/81Ua99CURsL._AC_UY327_FMwebp_QL65_.jpg",
  ...
  },
  {
    ...
    reviews: 500,
    image:
      "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1664450095i/62821812.jpg",
  ...
  },
  {
    ...
    reviews: 240,
    image:
      "https://tse2.mm.bing.net/th/id/OIP.aejXfNMqT-qOmvM6nQHegAAAAA?cb=ucfimg2&ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3",
...
function renderProducts() {
  ...
  // Update Count
  countLabel.innerText = `Showing ${filtered.length} book${
    filtered.length !== 1 ? "s" : ""
  }`;
    ...
    card.innerHTML = `
      ...
      product.title
            ...
            <div class="card-info">
                ...
                <h3 class="card-title" onclick="openProductModal(${
                  product.id
...
function openProductModal(id) {
  ...
  document.getElementById("modal-price").innerText = `$${product.price.toFixed(
    2
  )}`;
